# Домашнее задание к занятию «`Управляющие конструкции в коде Terraform`» - `Айткожоев Бактыбек`
...
![скриншот входящих правил «Группы безопасности» в ЛК Yandex Cloud](img/sec1.png)
---
